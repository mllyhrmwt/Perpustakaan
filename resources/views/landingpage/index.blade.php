...
<html lang="en">
    <head>
        ...
        <link href="../../assets/admin-2/css/styles.css" rel="stylesheet">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="dashboard">PERPUSTAKAAN</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="../assets/admin-2/assets/img/avataaars.svg" alt="..." />
                <!-- Masthead Heading-->
                <h3>Melly Hermawati</h3>
                <!-- Icon Divider-->
